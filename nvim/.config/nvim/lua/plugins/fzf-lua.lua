...
vim.keymap.set("n", "<C-p>f", fzf.files, { desc = "fzf-lua search for files in the current working directory" })
vim.keymap.set("n", "<C-p>g", fzf.live_grep, { desc = "fzf-lua live grep in the current working directory" })
