...
vim.keymap.set("n", "<C-p>gq", fzf.lgrep_quickfix, { desc = "fzf-lua live grep files in quickfix" })
vim.keymap.set("n", "<C-p>gw", fzf.grep_cword, { desc = "fzf-lua search word under cursor with grep" })
vim.keymap.set("n", "<leader>gG", fzf.git_status, { desc = "fzf-lua search git status" })
vim.keymap.set("n", "<C-p>h", fzf.helptags, { desc = "fzf-lua search helptags" })
vim.keymap.set("n", "<C-p>k", fzf.keymaps, { desc = "fzf-lua search through neovim keymaps" })
vim.keymap.set("n", "<C-p>ll", fzf.lgrep_loclist, { desc = "fzf-lua live grep files in location list" })
vim.keymap.set("n", "<C-p>lo", fzf.loclist, { desc = "open location in fzf-lua" })
...
vim.keymap.set("n", "<C-p>q", fzf.quickfix, { desc = "open quickfix in fzf-lua" })
...
vim.keymap.set("n", "<C-p>z", fzf.builtin, { desc = "fzf-lua search fzf-lua builtin pickers" })

vim.keymap.set("n", "<C-p>c", function()
  fzf.files({ cwd=vim.fn.expand("$HOME/dotfiles") })
end, { desc = "fzf-lua search for files in dotfiles" })

vim.keymap.set("n", "<C-p>n", function()
  fzf.live_grep({
    search_paths= { vim.fn.expand("$HOME/Dropbox/shm") },
  })
end, { desc = "fzf-lua live grep in notes" })
