...
## Links
- [VS Code Snippet Official Docs](https://code.visualstudio.com/docs/editing/userdefinedsnippets#_snippet-syntax)
- [vim-vsnip Docs](https://github.com/hrsh7th/vim-vsnip)
- [LSP Snippet Syntax - Microsoft](https://github.com/Microsoft/language-server-protocol/blob/main/snippetSyntax.md)
